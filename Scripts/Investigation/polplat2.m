...
figure; polarhistogram(ang_ChR2_old,'BinEdges',linspace(-0.5*pi,.5*pi,10),'Normalization','probability','FaceColor','r','FaceAlpha',1.0);
hold on; polarhistogram(ang_ChR2_new,'BinEdges',linspace(-0.5*pi,.5*pi,10),'Normalization','probability','FaceColor','g','FaceAlpha',0.3);%h.DisplayStyle = 'stairs';
...
ivt_graph({ang_ChR2_old , ang_ChR2_new},[],'xticklabels',{'tdTom','TAC1'},'showpoints',1,'errorbars','sem','test','ranksum')
